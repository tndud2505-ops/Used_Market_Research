...
| 검색 세션·사이트 보기·가격순 보강 | `web-backend/public/app.js`, `cloudflare/live-search.mjs`, `aws-runner/search-index.mjs`, `aws-runner/runner.mjs` | `npm run search-session:contract`, `npm run index:harness` |
