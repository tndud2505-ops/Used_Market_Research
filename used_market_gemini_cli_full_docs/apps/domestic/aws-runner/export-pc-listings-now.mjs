...
try {
  ...
  for (const row of rows) {
    ...
    items.push({
      ...
      form_factor: metadata.form_factor || null,
      listing_kind: metadata.listing_kind,
      pc_category_code: metadata.category_code || null,
      market_segment: metadata.market_segment || "UNKNOWN",
      listing_type: metadata.listing_type || "UNKNOWN",
      condition_group: metadata.condition_group || "UNKNOWN",
      spec_group_id: metadata.spec_group_id || null,
      classification_confidence: Number(metadata.classification_confidence || 0),
      model_confidence: Number(metadata.model_confidence || 0),
      quantity_confidence: Number(metadata.quantity_confidence || 0),
      price_scope_confidence: Number(metadata.price_scope_confidence || 0),
      statistics_eligible: metadata.statistics_eligible === true,
      statistics_exclusion_reasons: metadata.statistics_exclusion_reasons || [],
