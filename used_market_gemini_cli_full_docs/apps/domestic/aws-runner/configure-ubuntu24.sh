...
existing_pc_source_targets_per_run="$(read_env_value PC_SOURCE_TARGETS_PER_RUN)"
existing_pc_source_target_concurrency="$(read_env_value PC_SOURCE_TARGET_CONCURRENCY)"
existing_pc_hellomarket_detail_limit="$(read_env_value PC_HELLOMARKET_DETAIL_LIMIT)"
...
PC_SOURCE_TARGETS_PER_RUN=${pc_source_targets_per_run}
PC_SOURCE_TARGET_CONCURRENCY=${pc_source_target_concurrency}
PC_HELLOMARKET_DETAIL_LIMIT=${pc_hellomarket_detail_limit}
