...
try {
  ...
  const fallbackTargetId = "pc-target:2:category-v8:GPU";
...
const freshnessTargetIds = Object.freeze({
  bunjangGpu: "pc-target:2:market-v8:GPU:0",
  danawaGpu: "pc-target:2:category-v8:GPU",
  danawaCpu: "pc-target:2:category-v8:CPU"
});
